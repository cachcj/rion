...
\newcommand{\namedesautors}{P.~Augustin, J.~Skopp, C.~Juin, G.~Lehmann, A.~Schmidt, R.~Rapport}
\newcommand{\themaderarbeit}{Ewok - Package Manager}
...
\input{Vorgehensmodell.tex}
\input{Produkteinsatz.tex}
\input{Produktumgebung.tex}
\input{Produktfunktionen.tex}
% \input{Produktdaten.tex} Cheaten
\input{Qualitaetszielbestimmungen.tex}
\input{Testszenarien.tex}
\input{Entwicklungsumgebungen.tex}
\input{UML.tex}
