...
\begin{itemize}
	\item 
		Der Package-Manager ewok soll sich selbst installieren können. Dies soll über PyPi (pip) und aur genutzt werden. Das Ziel ist hier, dass jede Linuxdistribution den Manager wie jedes andere bekannte \quotes{Command Line Programm} nutzen kann.
	
	\item Der Packagemanager ewok soll sich erfolgreich \quotes{informieren} können, ob er alle erforderlichen Anforderungen erfüllt und gegebenenfalls interagieren kann. Dazu zählt Folgendes:
