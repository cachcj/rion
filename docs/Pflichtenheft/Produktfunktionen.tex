...
\begin{itemize}
	\item[F0110] \textit{Installation:} Der Nutzer kann mit \quotes{ewok install \textit{Packagename}} Pakete installieren.
	...
	\item[F0150] \textit{Entfernen:} Der Nutzer kann mit \quotes{ewok remove \textit{Packagename/s}} Pakete deinstallieren.
