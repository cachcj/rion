...
\begin{itemize}
	...
	\item[F0170] \textit{Installierte Pakete listen:} Der Nutzer erhält durch \quotes{\textit{rion list (package\_name\_pattern)}} eine Liste aller installierten Pakete, bzw aller installierten Funktionen eines Paketes.
	...
	\item[F0131] RION kann sich mit \quotes{rion auth -u >>USER<< -p >>PWD<<} anmelden. RION kann sich auch über einen Configfile (nur für den Ersteller lesbar) anmelden. Sollte keine Anmeldung vorliegen fragt RION beim ersten Aufruf nach den Anmeldedaten.
\end{itemize}
...
\begin{itemize}
	...
	\item[F0220] \textit{Neue Version hinzufügen:} Der Nutzer kann mit \quotes{inor update \textit{Packagename Packageversion Packagefile}} eine neue Version eines Paketes zur Datenbank hinzufügen. Alte Versionen bleiben erhalten.
