...
\begin{itemize}
	\item[T0110] \textit{Installation:} Der Nutzer installiert mit \quotes{ewok install \textit{Packagename}} ein Paket. Das Paket wird installiert. Skripte werden erfolgreich ausgeführt.
